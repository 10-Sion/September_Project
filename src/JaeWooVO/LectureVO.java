...
public class LectureVO {
	...
	private String pro_email; //교수 이메일
	private String major; //전공
	private int credit; // 학점
	private String comp_sort; // 이수 구분
	private int grade ; // 학년
	private String period; // 개설 학기
	private String edu_goal; //교육 목표
	...
	public String getComp_sort() {
		return comp_sort;
	}
	public void setComp_sort(String comp_sort) {
		this.comp_sort = comp_sort;
	}
	public int getGrade() {
		return grade;
	}
