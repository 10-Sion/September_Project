...
<%
	...
	// list.jsp에서 넘어온 num값과 nowPage값 받기
	...
	bMgr.upCount(num); // 게시물 읽어오기 전에 조회수 증가
	BoardBean bean = bMgr.getBoard(num); // 요청한 게시물 빈즈 단위로 가져오기
...
<table align="center" width="70%" border=0 cellspacing="3" cellpadding="0">
	...
	&nbps;&nbps;<font color="blue">(<%=filesize%>KBytes)</font>
	<%} else{%> 등록된 파일이 없습니다. <%} %>
	</td>
	</tr>
