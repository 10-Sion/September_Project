...
<%@ page import="jun_chamgo.WeekInfoDAO" %> <!-- WeekInfoDAO 클래스를 import합니다. -->
...
// WeekInfoDAO 객체 생성
WeekInfoDAO weekInfoDAO = new WeekInfoDAO(dataSource); // WeekInfoDAO 객체 생성

// WeekInfo 데이터 가져오기
List<jun_chamgo.WeekInfo> recentWeekInfo = weekInfoDAO.getRecentWeekInfo(4); // WeekInfoDAO를 통해 데이터 가져오기
%>
