...
<% String contextPath = request.getContextPath(); 
   int sub_no = 10053;//Integer.parseInt(request.getParameter("sub_no")); 
%>
요청할 서블릿 : <%= contextPath %>/Lecture/InsertWeek.do

<form id="week" action="<%= contextPath %>/Lecture/InsertWeek.do">
    <div class="table">
